          ...
          <div className='login-form'>
            <div className='login-form__container'>
              ...
              <p className='login-form__sign-up-label'>
                Не маєте акаунта?
                <span className='login-form__sign-up-link'>
                  Реєструйтесь тут!
                </span>
              </p>
              <div className='login-form__buttons-container'>
                <div className='login-form__social-button login-form__social-button--apple'>
                  <svg
                    stroke='currentColor'
                    fill='currentColor'
                    strokeWidth={0}
                    className='login-form__apple-icon'
                ...
                <div className='login-form__social-button login-form__social-button--google'>
                  <svg
                    stroke='currentColor'
                    fill='currentColor'
                    strokeWidth={0}
